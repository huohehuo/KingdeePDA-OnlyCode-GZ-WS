...
public class GetSettingList {
    ...
    public static ArrayList<SettingList> getPurchaseList4P2() {
        ArrayList<SettingList> items = new ArrayList<>();

        items.add(new SettingList("1",R.mipmap.chuku,"扫描查询"));
        items.add(new SettingList("2",R.mipmap.chuku,"销售出库"));
        items.add(new SettingList("5",R.mipmap.chuku,"销售出库红字"));
        items.add(new SettingList("3",R.mipmap.diaobo,"查询条码记录"));
        items.add(new SettingList("4",R.mipmap.pandian,"盘点单"));
