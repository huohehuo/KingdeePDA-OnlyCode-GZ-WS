...
//        spEmployee.setSelection(share.getDBEmployee());
    ...
    @OnClick({R.id.scanbyCamera, R.id.search_dbtype, R.id.search, R.id.btn_add, R.id.btn_finishorder, R.id.btn_backorder, R.id.btn_checkorder, R.id.tv_date})
...
//        ab.create().show();
    ...
    private void upload() {
        ...
        pBean.list = data;
        DataModel.upload(mContext,getBaseUrl()+ WebApi.DBUPLOAD,gson.toJson(pBean));
//        postToServer(data);
    }
