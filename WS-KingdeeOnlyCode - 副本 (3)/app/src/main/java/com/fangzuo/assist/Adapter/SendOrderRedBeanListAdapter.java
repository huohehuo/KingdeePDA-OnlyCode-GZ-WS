...
public class SendOrderRedBeanListAdapter extends BaseAdapter {
    Context context;
    List<SendOrderListBean> items;

    public SendOrderRedBeanListAdapter(Context context, List<SendOrderListBean> items) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.send_order_red_product_list, null);
