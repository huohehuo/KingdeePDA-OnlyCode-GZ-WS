if (exists (select * from sys.objects where name = 'proc_SupplyOutStoreBarCodeRed_Insert'))
    drop proc proc_SupplyOutStoreBarCodeRed_Insert
go
create proc proc_SupplyOutStoreBarCodeRed_Insert
(
