...
/**
 */
@WebServlet("/GyRedUpload")
public class GyRedUpload extends HttpServlet {
...
//				for(int i =0;i<pBean.list.size();i++){
					sta = conn.prepareStatement("exec proc_PushCheckLogisticsSingle_Red ?");
					String main = pBean.list.get(0).main;
					sta.setString(1, pBean.list.get(0).detail.get(0));
//					sta.setString(2, "");
//					sta.setString(3, "");
//					sta.setString(4, "");
//					sta.setString(5, "");
