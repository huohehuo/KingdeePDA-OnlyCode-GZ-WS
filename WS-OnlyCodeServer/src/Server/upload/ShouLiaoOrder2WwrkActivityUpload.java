 ...
 */
@WebServlet("/ShouLiaoOrder2WwrkActivityUpload")
public class ShouLiaoOrder2WwrkActivityUpload extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShouLiaoOrder2WwrkActivityUpload() {
        super();
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				...
				for(int i =0;i<pBean.list.size();i++){
					sta = conn.prepareStatement("exec proc_PushReceivingOutsourceIn ?,?,?,?,?,?");
