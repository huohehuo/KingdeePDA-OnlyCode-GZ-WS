 ...
 */
@WebServlet("/PdBackMsg2SaleOutUpload")
public class PdBackMsg2SaleOutUpload extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public PdBackMsg2SaleOutUpload() {
        super();
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				...
				for(int i =0;i<pBean.list.size();i++){
					sta = conn.prepareStatement("exec proc_ReturnGoodsCheck ?,?,?,?,?,?");
