 ...
 */
@WebServlet("/WwOrder2SLTZActivityUpload")
public class WwOrder2SLTZActivityUpload extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public WwOrder2SLTZActivityUpload() {
        super();
    }
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				...
				for(int i =0;i<pBean.list.size();i++){
					sta = conn.prepareStatement("exec proc_OutsourcingOrderReceiving ?,?,?,?,?,?");
