 ...
 */
@WebServlet("/CodeCheckOut4PdSn")
public class CodeCheckOut4PdSn extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public CodeCheckOut4PdSn() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				...
				sta = conn.prepareStatement("exec proc_OutStoreBarCode2_check ?,?");

					sta.setString(1, bean.FBarCode);
					sta.setString(2, bean.FIfCheck);
