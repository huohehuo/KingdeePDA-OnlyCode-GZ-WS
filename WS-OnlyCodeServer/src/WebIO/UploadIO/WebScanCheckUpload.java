 ...
 */
@WebServlet("/WebScanCheckUpload")
public class WebScanCheckUpload extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public WebScanCheckUpload() {
        super();
...
//				for(int i =0;i<pBean.list.size();i++){
					sta = conn.prepareStatement("exec proc_UpLoadBarCodeSignScan ?");
