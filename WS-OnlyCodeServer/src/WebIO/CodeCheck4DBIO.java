 ...
 *           销售出库：条码检测与写入临时表
 */
@WebServlet(urlPatterns = "/CodeCheck4DBIO")
public class CodeCheck4DBIO extends HttpServlet {
...
//        Lg.e("列表",testBS);
            try {
                ...
                sta = conn.prepareStatement("exec proc_Allot1_check ?");
...
//                sta.setString(2, pdfid);
                ...
                Lg.e("得到数据",container);
                if (container.size()>0 && container.get(0).FTip.startsWith("OK")){
