 ...
 */
@WebServlet(urlPatterns = "/ProductTypeIO")
public class ProductTypeIO extends HttpServlet {
...
//        String version = request.getParameter("version");
        ...
        ResultSet rs = null;
        ArrayList<WebResponse.ProductType> container = new ArrayList<>();
...
//        Lg.e("列表",testBS);
            try {
                ...
                SQL = "select FItemID,FNumber,FName from t_Item_2043";
                ...
                if(rs!=null){
                    int i = rs.getRow();
                    while (rs.next()) {
                        WebResponse.ProductType bean = webResponse.new ProductType();
                    ...
                    webResponse.productTypes = container;
