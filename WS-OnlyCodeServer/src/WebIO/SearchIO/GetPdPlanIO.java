 ...
 */
@WebServlet("/GetPdPlanIO")
public class GetPdPlanIO extends HttpServlet {
...
//            SQL = "select t1.FName as 盘点方案名称,t1.FID as 盘点方案ID,CONVERT(varchar(50), t1.FDate,20) as 日期,t2.FName as 制单人,t1.FRemark as 备注 from t_PDABarCodeCheckFirst t1 left join t_user t2 on t1.FUserID=t2.FUserID";
            SQL = "select a.FID 顺序号,a.FName as 盘点方案名称,FRemark as 备注,a.FDate 日期,b.fname as 制单人 from t_PDABarCodeCheck a join t_user b on a.FUserID=b.fuserid  and a.fstatus=0  order by fid Desc";
