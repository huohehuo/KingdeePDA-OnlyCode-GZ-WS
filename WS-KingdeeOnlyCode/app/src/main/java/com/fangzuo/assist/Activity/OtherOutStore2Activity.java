...
public class OtherOutStore2Activity extends BaseActivity {
...
//    SpinnerPeople spManager;
    ...
    private int activity = Config.OtherOutStore2Activity;
...
//                break;
    ...
    protected void initView() {
        setContentView(R.layout.activity_other_out_store2);
        mContext = this;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_checkorder:
                ...
                startNewActivity(ReViewForPDInOutActivity.class, R.anim.activity_fade_in, R.anim.activity_fade_out, false, b2);
                break;
            case R.id.tv_date:
                datePicker(tvDate);
                break;
...
//                    edNum.setText("1.0");
    ...
    private void setDATA(String fnumber, boolean flag) {
        ...
        if (flag) {
            ...
            if (BasicShareUtil.getInstance(mContext).getIsOL()) {
                App.getRService().doIOAction(WebApi.SEARCHPRODUCTS,fnumber, new MySubscribe<CommonResponse>() {
...
//                    tvNuminstorage.setText((qty/unitrate) + "");
                    tvNuminstorage.setText(dealStoreNumForOut(qty + ""));
    ...
    public void finishOrder() {
        ...
        ab.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                share.setOrderCode(OtherOutStore2Activity.this,ordercode);
            }
        });
