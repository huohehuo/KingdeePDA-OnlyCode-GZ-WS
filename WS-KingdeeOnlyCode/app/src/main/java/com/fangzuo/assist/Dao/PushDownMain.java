...
@Entity
    ...
    public String getFPhoneAddress() {
        return this.FPhoneAddress;
    }
    public void setFPhoneAddress(String FPhoneAddress) {
        this.FPhoneAddress = FPhoneAddress;
    }
    public String getFIfCheck() {
        return this.FIfCheck;
    }
    public void setFIfCheck(String FIfCheck) {
        this.FIfCheck = FIfCheck;
    }
    @Generated(hash = 1972796317)
    public PushDownMain(Long id, String FBillNo, String FName, String FDate,
            ...
            String FInterID, String FPhoneAddress, String FIfCheck, int tag) {
        this.id = id;
        this.FBillNo = FBillNo;
        this.FName = FName;
        this.FDate = FDate;
