...
public class OtherOutStore4RedActivity extends BaseActivity {
...
//    private StorageSpAdapter storageSpAdapter;
    ...
    private int activity = Config.OtherOutStore4RedActivity;
...
//                break;
    ...
    protected void initView() {
        setContentView(R.layout.activity_other_out_store4_red);
        mContext = this;
...
//                    Toast.showText(mContext, Msg);
    ...
    private void AddorderBefore() {
        ...
        if ("".equals(spEmployee.getEmployeeId())) {
            Toast.showText(mContext, "请选择业务员");
            MediaPlayer.getInstance(mContext).error();
            lockScan(0);
            return;
        }
...
//        }
        ...
        bean.FStockID=storage.FItemID;
        bean.FStockPlaceID = wavehouseID;
    ...
    public void finishOrder() {
        ...
        ab.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                share.setOrderCode(OtherOutStore4RedActivity.this,ordercode);
            }
        });
