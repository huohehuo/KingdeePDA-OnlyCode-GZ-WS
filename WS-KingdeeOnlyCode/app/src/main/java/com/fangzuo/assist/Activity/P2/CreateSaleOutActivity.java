...
public class CreateSaleOutActivity extends BaseActivity {
    ...
    private int activity = Config.CreateSaleOutActivity;
...
//摄像头初始化
    ...
    protected void OnReceive(String code) {
        ...
        DataModel.codeCheck(WebApi.CodeCheck4Saleout, gson.toJson(bean));
    }
...
//                startActivityForResult(in, 0);
    ...
    private void AddorderBefore() {
        ...
        DataModel.codeInsert(WebApi.CodeInsert4Saleout, gson.toJson(bean));
    }
