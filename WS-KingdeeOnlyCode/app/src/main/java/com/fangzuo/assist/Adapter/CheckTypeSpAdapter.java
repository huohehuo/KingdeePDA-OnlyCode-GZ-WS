...
public class CheckTypeSpAdapter extends BaseAdapter {
    Context context;
    List<CheckType> items;
    private ViewHolder viewHolder;

    public CheckTypeSpAdapter(Context context, List<CheckType> items) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tv.setText(items.get(i).FBillNo);
        return view;
    }
