...
public class OutsourcingOrdersIS2Activity extends BaseActivity {
    private int tag =26;
    private int activity = Config.OutsourcingOrdersIS2Activity;
...
//                    ).build().list();
    ...
    public static void start(Context context, String code, ArrayList<String> fid) {
        Intent starter = new Intent(context, OutsourcingOrdersIS2Activity.class);
