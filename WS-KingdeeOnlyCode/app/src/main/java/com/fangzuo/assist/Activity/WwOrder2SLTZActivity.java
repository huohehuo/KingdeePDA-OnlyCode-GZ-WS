...
public class WwOrder2SLTZActivity extends BaseActivity {
    private int tag =30;
    private int activity = Config.WwOrder2SLTZActivity;
...
//                        }
    ...
    protected void initView() {
        setContentView(R.layout.activity_ww_order2_sltz);
        mContext = this;
...
//        }
    ...
    private void postToServer(final ArrayList<PurchaseInStoreUploadBean.purchaseInStore> data) {
        ...
        pBean.list = data;
        Gson gson = new Gson();
        App.getRService().doIOAction(WebApi.WwOrder2SLTZActivityUpload, gson.toJson(pBean), new MySubscribe<CommonResponse>() {
            @Override
