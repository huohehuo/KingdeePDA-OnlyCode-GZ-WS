 ...
 */
@WebServlet("/CodeCheck4SaleoutRed")
public class CodeCheck4SaleoutRed extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public CodeCheck4SaleoutRed() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				...
				sta = conn.prepareStatement("exec proc_SupplyOutStoreBarCodeRed_check ?,?");

					sta.setString(1, bean.FBarCode);
					sta.setString(2, bean.FUserID);
