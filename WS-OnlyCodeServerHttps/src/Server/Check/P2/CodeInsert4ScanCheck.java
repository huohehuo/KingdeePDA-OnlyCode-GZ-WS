...
/**
 */
@WebServlet("/CodeInsert4ScanCheck")
public class CodeInsert4ScanCheck extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public CodeInsert4ScanCheck() {
        super();
    }
		...
		if(parameter!=null&&!parameter.equals("")){
			try {
				...
				CheckInOutBean bean = gson.fromJson(parameter, CheckInOutBean.class);
					sta = conn.prepareStatement("exec proc_BarCodeSignScan_Insert ?,?,?");
