 ...
 */
@WebServlet("/CodeCheck4Bulk")
public class CodeCheck4Bulk extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public CodeCheck4Bulk() {
        super();
