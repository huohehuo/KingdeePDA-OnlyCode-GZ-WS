 ...
 */
@WebServlet("/CreateSO4PostUpload")
public class CreateSO4PostUpload extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateSO4PostUpload() {
        super();
...
//		String parameter = request.getParameter("json");
		...
		Lg.e("到达");
		try{
            getbody = JDBCUtil.ReadAsChars(request);//获取post请求中的body数据
            postBean = gson.fromJson(getbody, PostBean.class);//解析
...
//				conn = JDBCUtil.getConn(getDataBaseUrl.getUrl(request.getParameter("sqlip"), request.getParameter("sqlport"), request.getParameter("sqlname")), request.getParameter("sqlpass"), request.getParameter("sqluser"));
				conn = JDBCUtil.getConn(getDataBaseUrl.getUrl(postBean.sqlip, postBean.sqlport, postBean.sqlname),postBean.sqlpass, postBean.sqluser);
