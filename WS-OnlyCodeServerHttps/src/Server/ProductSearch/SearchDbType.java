 ...
 */
@WebServlet(urlPatterns = "/SearchDbType")
public class SearchDbType extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ResultSet rs = null;
        ArrayList<DownloadReturnBean.DbType> container = new ArrayList<>();
        ...
        if (parameter != null) {
            try {
                ...
                if(rs!=null){
                    ...
                    while (rs.next()) {
                        DownloadReturnBean.DbType productBean = downloadReturnBean.new DbType();
                        productBean.FInterID = rs.getString("FInterID");
                        productBean.FID = rs.getString("FID");
                        productBean.FName = rs.getString("FName");
                        container.add(productBean);
                    }
                    downloadReturnBean.dbTypes = container;
