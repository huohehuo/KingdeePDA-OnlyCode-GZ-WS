 ...
 */
@WebServlet(urlPatterns = "/ClientIO")
public class ClientIO extends HttpServlet {
...
//        String version = request.getParameter("version");
        ...
        ResultSet rs = null;
        ArrayList<WebResponse.Client> container = new ArrayList<>();
...
//        Lg.e("列表",testBS);
            try {
                ...
                SQL = "select t2.FItemID,t2.FNumber,t2.FName from t_UserPDASupply t1 left join t_Organization t2 on t1.FCustID=t2.FItemID";
                ...
                if(rs!=null){
                    int i = rs.getRow();
                    while (rs.next()) {
                        WebResponse.Client bean = webResponse.new Client();
