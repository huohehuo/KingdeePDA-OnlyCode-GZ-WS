...
public class PushDownMainDao extends AbstractDao<PushDownMain, Long> {
    ...
    public static class Properties {
        ...
        public final static Property FPhoneAddress = new Property(9, String.class, "FPhoneAddress", false, "FPHONE_ADDRESS");
        public final static Property FIfCheck = new Property(10, String.class, "FIfCheck", false, "FIF_CHECK");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PUSH_DOWN_MAIN\" (" + //
                ...
                "\"FPHONE_ADDRESS\" TEXT," + // 9: FPhoneAddress
                "\"FIF_CHECK\" TEXT," + // 10: FIfCheck
    ...
    protected final void bindValues(DatabaseStatement stmt, PushDownMain entity) {
        ...
        String FPhoneAddress = entity.getFPhoneAddress();
        if (FPhoneAddress != null) {
            stmt.bindString(10, FPhoneAddress);
        }
 
        String FIfCheck = entity.getFIfCheck();
        if (FIfCheck != null) {
            stmt.bindString(11, FIfCheck);
        }
    ...
    public PushDownMain readEntity(Cursor cursor, int offset) {
        PushDownMain entity = new PushDownMain( //
            ...
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), // FPhoneAddress
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // FIfCheck
    ...
    public void readEntity(Cursor cursor, PushDownMain entity, int offset) {
        ...
        entity.setFPhoneAddress(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
        entity.setFIfCheck(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
