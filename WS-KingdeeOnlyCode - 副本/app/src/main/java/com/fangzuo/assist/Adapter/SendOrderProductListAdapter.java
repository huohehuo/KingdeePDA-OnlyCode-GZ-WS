...
public class SendOrderProductListAdapter extends BaseAdapter {
    Context context;
    List<SendOrderResult.DeliverysBean.DetailsBean> items;

    public SendOrderProductListAdapter(Context context, List<SendOrderResult.DeliverysBean.DetailsBean> items) {
...
//        viewHolder.billNo.setText("订单编号:"+items.get(i).getCode());
        ...
        viewHolder.tvModel.setText("规格型号:"+items.get(i).getSku_name()==null?"无":items.get(i).getSku_name());
