...
public class T_Detail {
    ...
    public String IsAssemble;       //是否为箱码，传入barcode，否则空
    ...
    public String getFApiClient() {
        return this.FApiClient;
    }

    public void setFApiClient(String FApiClient) {
        this.FApiClient = FApiClient;
    }

    public String getFApiSendNo() {
        return this.FApiSendNo;
    }

    public void setFApiSendNo(String FApiSendNo) {
        this.FApiSendNo = FApiSendNo;
    }

    public String getFApiPTNo() {
        return this.FApiPTNo;
    }
