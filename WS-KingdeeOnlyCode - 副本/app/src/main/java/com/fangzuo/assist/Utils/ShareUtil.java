...
public class ShareUtil {
    ...
    public void setOrderCode(Activity activity,String no, long orderCode){
        editor.putLong(activity.getClass().getSimpleName()+no,orderCode).apply();
    }
    public long getOrderCode(Activity activity,String no){
        return shared.getLong(activity.getClass().getSimpleName()+no,0);
    }
    //获取单据的单据编号：key为activity的类名字
    ...
    public void setPackageCode(long setPackageCode){
        editor.putLong("setPackageCode",setPackageCode).apply();
    }
    public long getPackageCode(){
        return shared.getLong("setPackageCode",0);
    }
    ...
    public void  setPackageAuto(boolean isAuto){
        editor.putBoolean("setPackageAuto",isAuto).apply();
    }

    public boolean getPackageAuto(){
        return shared.getBoolean("setPackageAuto",false);
    }
