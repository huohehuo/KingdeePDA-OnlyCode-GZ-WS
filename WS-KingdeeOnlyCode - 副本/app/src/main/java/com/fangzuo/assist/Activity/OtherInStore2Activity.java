...
//          其他入库
public class OtherInStore2Activity extends BaseActivity {
...
//    SpinnerPeople spManager;
    ...
    private int activity = Config.OtherInStore2Activity;
    ...
    protected void initView() {
        setContentView(R.layout.activity_other_in_store2);
        mContext = this;
